<x-app-layout>
    ...
    <div class="container-fluid py-4 px-3 px-lg-4">
        ...
        <div class="row g-3 mb-4">
            @foreach([['label'=>'إجمالي اللجان','key'=>'committees'],['label'=>'الحكام','key'=>'judges'],['label'=>'الطلاب الموزّعون','key'=>'students']] as $card)
        ...
        @if($committees->count())<div class="d-none d-md-block"><x-ui.data-table :headers="['اللجنة','المسابقة','المستوى','الحكام','الطلاب','تاريخ الإنشاء','الإجراءات']">
            @foreach($committees as $committee)<tr>
                ...
                <td>
                    <span class="badge text-bg-light border">الحكام: {{ $committee->users_count + $committee->manual_judges_count }}</span>
                </td>
                <td>
